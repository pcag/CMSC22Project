...
public class Student extends Sprite{
	...
	public final static Image STUDENT_IMAGE = new Image("images/Student.gif",Student.STUDENT_WIDTH,Student.STUDENT_WIDTH,false,false);
	...
	public void move() {
		...
		if(tempy < GameTimer.PANEL_SPACE || tempy > (GameStage.WINDOW_HEIGHT - STUDENT_SIZE)) {
			return;
		}
		this.y += this.dy;
	}
